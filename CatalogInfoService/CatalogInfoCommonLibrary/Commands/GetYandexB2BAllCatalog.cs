...
{
    public class GetYandexB2BAllCatalog : ICommand
    {
        public GetYandexB2BAllCatalog(ICommonCommandFactory factory, object[] args)
        {
        ...
        public async Task Execute()
        {
            ...
            {
                Factory.Resolve<ICommand>("Commands.SqlFilterCreators.CreateYandex_B2B_All_FilterCommand", new object[] {filterContainer}),
        ...
        public Task Undo()
        {
            throw new ImpossibleUndoException(nameof(GetYandexB2BAllCatalog));
        }
    }
}
